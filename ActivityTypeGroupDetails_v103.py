...
class Ui_ActivityTypeGroupDetails(object):
    def setupUi(self, ActivityTypeGroupDetails):
        ...
        self.pushButton_5.clicked.connect(self.Add_ActivityTypeGroupDetails)
...
"color: rgb(255, 255, 255);")
    ...
    def Add_ActivityTypeGroupDetails(self):
        ...
        self.cur.execute('''
            INSERT INTO ActivityTypeGroup SET Description=%s ,IsDeleted=%s
        ''', (
        description, isdeleted))

        self.db.commit()
        print("Activity Type Group Add")
